...
const Holidayguestinfo = () => {
  ...
  const [personList, setPersonList] = useState([{ name: '', dob : '', gender :'' }]);
              ...
              <Grid container spacing={3} my={1}>
                <Grid item xs={12} sm={12} lg={4}>
                  <Box className="topest_field" >
                    <label className="label_field"> Name<span style={{ color: 'red' }}>*</span></label>
                    <Box className='input_shadow' ml={3}>
                      <input className="input_decor" type='text' placeholder="Enter your name" name="name" onChange={(e)=>handlePersonChange(e, index)}/>
                    </Box>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={12} lg={4} py={1}>
                  <Box className="topest_field">
                    ...
                    <Box className='input_shadow' ml={3}>
                      <input className="input_decor" type='date'  name="dob" onChange={(e)=>handlePersonChange(e, index)} />
                    </Box>
                  </Box>
                </Grid>
                <Grid item xs={12} sm={12} lg={3}>
                  <Box className="topest_field" >
                    ...
                    <Box className='input_shadow' ml={3}>
                      <select name="gender" className="input_decor" onChange={(e)=>handlePersonChange(e, index)}>
