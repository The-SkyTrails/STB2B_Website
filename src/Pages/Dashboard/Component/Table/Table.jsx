                  ...
                  return (
                    <>
                      <StyledTableRow key={index}>
                        ...
                        <StyledTableCell align="right">
                          {ele.agency_details.address}
                        </StyledTableCell>
                        <StyledTableCell align="right">
                          {ele.agency_gst_details.agency_name}
                        </StyledTableCell>
                        <StyledTableCell align="right">
                        ...
                        <td className="" align="right">
                          ...
                          >
                            <span>
                              {ele.personal_details.password.slice(0, 32)}
                            </span>{" "}
                            <br />
                            <span>
                              {ele.personal_details.password.slice(
                                32,
                                ele.personal_details.password.length
                              )}
                            </span>
                          </Box>
                        </td>
                        ...
                        {/* {loading ? <div>Loading</div> :(
                          ...
                          {/* { ele.is_active == 1 && <span style={{backgroundColor:'green',padding:'10px',borderRadius:'7px'}}>Active</span> }
                          { ele.is_active == 0 && <span style={{backgroundColor:'red',padding:'10px',borderRadius:'7px'}}>Inactive</span> }
                ...
                <option value="inactive">Inactive</option>
                        ...
                        <StyledTableCell align="center">
                          ...
                          >
                            <TextField
                              ...
                              defaultValue={markupData[index].flight}
                              sx={{
                                width: "108px",
                                marginRight: "10px",
                                fontSize: "18px",
                        ...
                        <StyledTableCell align="center">
                          ...
                          >
                            <TextField
                              placeholder={
                                markupData[index].hotel
                                  ? markupData[index].hotel
                                  : "0"
                              }
                              defaultValue={markupData[index].hotel}
                              name="hotel"
                              sx={{
                                width: "128px",
                                marginRight: "10px",
                        ...
                        <StyledTableCell align="center">
                          ...
                          >
                            <TextField
                              placeholder={
                                markupData[index].bus
                                  ? markupData[index].bus
                                  : "0"
                              }
                              name="bus"
                              defaultValue={markupData[index].bus}
                              sx={{
                                width: "128px",
                                marginRight: "10px",
                                fontSize: "18px",
                        ...
                        <StyledTableCell align="center">
                          ...
                          >
                            <TextField
                              ...
                              variant="standard"
                              fullWidth
                              defaultValue={markupData[index].holiday}
                              onChange={(event) => handleMarkUp(event, ele._id)}
                            />
                            <button
                              color="success"
