...
function SingleData(props) {
  ...
  const handleClick = (keytype, ResultIndex) => {
    console.log(keytype, "Handel Click Index Key", ResultIndex);
    // navigate("passengerdetail");
    keytype == 0
      ? sessionStorage.setItem("DepartureResultIndex", ResultIndex)
      : sessionStorage.setItem("ReturnResultIndex", ResultIndex);
  };
